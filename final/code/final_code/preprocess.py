...
def main():
    ...
    convert(df_train, "../../data/wav/FSDKaggle2019.audio_train_curated", "../../data/dcase/mel128/train")
    print("converting noisy data...")
    convert(df_noisy, "../../data/wav/FSDKaggle2019.audio_train_noisy", "../../data/dcase/mel128/noisy")
    print("converting test data...")
    convert(df_test, "../../data/wav/FSDKaggle2019.audio_test", "../../data/dcase/mel128/test")
